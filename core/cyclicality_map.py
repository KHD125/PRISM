...
Cyclicality tier maps for the max_earnings_drawdown_5y / cyclicality_tier columns
...
⚠️ EDITING A TIER CHANGES SCORES. Corrected 2026-08-24 (this header previously said "display-only").
cyclicality_tier == 'Deep Cyclical / Commodity' caps fair_pe_qglp at 18.0, which flows into
pe_discount_to_quality → the valuation axis → composite_score (and Kelly sizing + verdict_engine).
Measured: re-tiering ONE industry moved 28 stocks' composite_score, max 0.28 pts — and it SPILLS to
sector peers because the valuation rank is sector-relative. Re-tier only behind /census + /verify.
See the block comment at data_engine.compute_derived_signals (~L2159) for the full path.
...
INDUSTRY_TIER = {
    ...
    'Automobiles - Scooters & 3 - Wheelers': 'B',
    ...
    'Cement': 'B',
    'Cement Products': 'B',
    'Ceramics - Sanitaryware/Others': 'B',
    'Ceramics - Tiles': 'B',
    ...
    'Trading': 'F',
    'Transmission Line Towers/Equipment': 'D',
